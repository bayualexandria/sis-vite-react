...
function DeleteSemesterById({ id }) {
    const popUpDeleteSemesterById = async () => {
                ...
                try {
                    if (result.isConfirmed) {
                        ...
                        setTimeout(async () => {
                            ...
                            console.log(token[0]);
                            await fetch(`${repositori}semester/${id}`, {
                                method: "DELETE",
                                headers: {
    ...
    return (
        <div className="cursor-pointer" onClick={popUpDeleteSemesterById}>
...
export default DeleteSemesterById;
