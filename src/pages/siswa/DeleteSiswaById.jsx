...
function DeleteSiswaById({ username }) {
  const popUpDeleteSiswaById = async () => {
      ...
      .then(async (result) => {
        try {
          if (result.isConfirmed) {
            ...
            setTimeout(async () => {
              await api.delete(`/siswa/${username}`, {
  ...
  return (
    <div onClick={popUpDeleteSiswaById} className="cursor-pointer outline-none">
...
export default DeleteSiswaById;
