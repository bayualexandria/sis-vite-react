...
function GetById() {
  ...
  const getSiswaById = async () => {
    console.log(nis);
    try {
      let response = await api.get(`siswa/${nis}`).then((res) => res.data);
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        return Swal.fire({
          ...
          text:
            error.response?.data?.message ||
            "Terjadi kesalahan saat mengubah data siswa.",
        });
      }
    }, 5000);
  };
                      ...
                      <div className="flex flex-row gap-x-5">
                        <div className="flex flex-row gap-x-3">
                          <input
                            ...
                            defaultChecked={siswa.jenis_kelamin === "Laki-laki"}
                          />
                        ...
                        <div className="flex flex-row gap-x-3">
                          <input
                            ...
                            value="Perempuan"
                            onChange={(e) => setJenisKelamin(e.target.value)}
                            defaultChecked={siswa.jenis_kelamin === "Perempuan"}
                          />
