...
function ShowDataTrashSiswa() {
  ...
  const restoreDataAll = async () => {
    await templateModal
      .fire({
        title: "Restore all data siswa",
        text: "Apakah anda ingin restore semua data siswa!",
        icon: "info",
  ...
  const deletePermanen = async () => {
    await templateModal
      .fire({
        title: "Delete all data siswa",
        text: "Apakah anda ingin hapus semua data siswa!",
        icon: "warning",
        showCancelButton: true,
        confirmButtonText: "Ya",
        cancelButtonText: "Tidak",
      ...
      .then(async (result) => {
        try {
          if (result.isConfirmed) {
            ...
            try {
              await fetch(`${repositori}siswa/delete-permanent`, {
                method: "DELETE",
                headers: {
  ...
  useEffect(() => {
    const result = dataTrash.filter((item) => {
      return (
        ...
        item.nis.toLowerCase().match(searchTrash.toLowerCase()) ||
